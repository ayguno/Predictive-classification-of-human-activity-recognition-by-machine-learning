...
We found that the combinations of the individual models stacked by RF,SVM and GBM further increased the overall accuracy of the predictions. They provided the same level of overall accuracy:  0.9989804  

We will perform the predictions on the final_testing data set by using the combined models:
