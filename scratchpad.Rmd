...
# General preprocessing and EDA (all processing performed in the building set and exactly applied to tune.testing and validation sets)
...
##########################################
# STEP1: Drop the missing value containing variables as they are unlikely to add value to our #prediction (process the tune.testing and validation sets exactly in the same way )
...
##########################################
# STEP 2: Remove nzv variables, (process the tune.testing and validation sets exactly in the same way )
...
# Next we can start model building approaches
